...
public class KafkaConfigModule {
    ...
    static Map<String, Object> providesKafkaConsumerConfig(ApplicationProperties applicationProperties, @Named("kafkaApplicationName") String applicationName) {
        var consumerConfigs = new HashMap<String, Object>();
        var username = applicationProperties.getRequiredProperty("kafka.username");
        ...
        return commonConfig(applicationProperties, applicationName, consumerConfigs);
    }

    private static Map<String, Object> commonConfig(ApplicationProperties applicationProperties, String applicationName, Map<String, Object> concreteConfig) {
        var commonProperties = applicationProperties.getProperties("kafka")
                .entrySet()
                .stream()
        ...
        var username = applicationProperties.getRequiredProperty("kafka.username");
        var password = applicationProperties.getRequiredProperty("kafka.password");

        config.put(CommonClientConfigs.BOOTSTRAP_SERVERS_CONFIG, applicationProperties.getRequiredProperty("kafka.bootstrap.servers"));
